...
begin
EXEC [MRTEC].[dbo].[sp_fulltext_database] @action = 'enable'
end
GO
ALTER DATABASE [MRTEC] SET ANSI_NULL_DEFAULT OFF 
GO
ALTER DATABASE [MRTEC] SET ANSI_NULLS OFF 
GO
ALTER DATABASE [MRTEC] SET ANSI_PADDING OFF 
GO
ALTER DATABASE [MRTEC] SET ANSI_WARNINGS OFF 
GO
ALTER DATABASE [MRTEC] SET ARITHABORT OFF 
GO
ALTER DATABASE [MRTEC] SET AUTO_CLOSE OFF 
GO
ALTER DATABASE [MRTEC] SET AUTO_SHRINK OFF 
GO
ALTER DATABASE [MRTEC] SET AUTO_UPDATE_STATISTICS ON 
GO
ALTER DATABASE [MRTEC] SET CURSOR_CLOSE_ON_COMMIT OFF 
GO
ALTER DATABASE [MRTEC] SET CURSOR_DEFAULT  GLOBAL 
GO
ALTER DATABASE [MRTEC] SET CONCAT_NULL_YIELDS_NULL OFF 
GO
ALTER DATABASE [MRTEC] SET NUMERIC_ROUNDABORT OFF 
GO
ALTER DATABASE [MRTEC] SET QUOTED_IDENTIFIER OFF 
GO
ALTER DATABASE [MRTEC] SET RECURSIVE_TRIGGERS OFF 
GO
ALTER DATABASE [MRTEC] SET  DISABLE_BROKER 
GO
ALTER DATABASE [MRTEC] SET AUTO_UPDATE_STATISTICS_ASYNC OFF 
GO
ALTER DATABASE [MRTEC] SET DATE_CORRELATION_OPTIMIZATION OFF 
GO
ALTER DATABASE [MRTEC] SET TRUSTWORTHY OFF 
GO
ALTER DATABASE [MRTEC] SET ALLOW_SNAPSHOT_ISOLATION OFF 
GO
ALTER DATABASE [MRTEC] SET PARAMETERIZATION SIMPLE 
GO
ALTER DATABASE [MRTEC] SET READ_COMMITTED_SNAPSHOT OFF 
GO
ALTER DATABASE [MRTEC] SET HONOR_BROKER_PRIORITY OFF 
GO
ALTER DATABASE [MRTEC] SET RECOVERY SIMPLE 
GO
ALTER DATABASE [MRTEC] SET  MULTI_USER 
GO
ALTER DATABASE [MRTEC] SET PAGE_VERIFY CHECKSUM  
GO
ALTER DATABASE [MRTEC] SET DB_CHAINING OFF 
GO
ALTER DATABASE [MRTEC] SET FILESTREAM( NON_TRANSACTED_ACCESS = OFF ) 
GO
ALTER DATABASE [MRTEC] SET TARGET_RECOVERY_TIME = 0 SECONDS 
GO
ALTER DATABASE [MRTEC] SET DELAYED_DURABILITY = DISABLED 
GO
ALTER DATABASE [MRTEC] SET QUERY_STORE = OFF
GO
USE [MRTEC]
GO
...
USE [master]
GO
ALTER DATABASE [MRTEC] SET  READ_WRITE 
GO
